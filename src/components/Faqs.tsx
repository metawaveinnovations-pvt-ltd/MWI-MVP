...
const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Thanks to our Pakistan-based engineering team and globally connected remote collaboration network, we can mobilize a fully staffed, dedicated engineering team (including full-stack developers, QA leads, and DevOps specialists) within 48 to 72 hours of contract execution.',
    highlights: [
  ...
  // Security & SLAs
  {
    ...
    answer: 'We enforce SecOps practices across the software lifecycle. Our applications adhere to OWASP Top 10 security guidelines, featuring AES-256 data encryption at rest, TLS 1.3 in transit, automated vulnerability dependency scanning, and zero-trust authentication. We architect secure software solutions designed for healthcare, fintech, e-commerce, and enterprise applications.',
    highlights: [
      'Enterprise-grade security aligned engineering processes',
      'Secure and privacy-focused data storage and sanitization',
        ...
        <div className="max-w-3xl mx-auto mb-10">
          <div className="relative mb-6">
            ...
            <input
              ...
              placeholder="Search by keywords (e.g., 'IP ownership', 'React', 'pricing', 'security', 'SLA', 'Gemini')..."
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xs relative">
              {inquirySuccess ? (
                ...
                <form onSubmit={handleInquirySubmit} className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="inquiryCategory" className="block text-[11px] font-mono font-bold text-slate-600 mb-1">INQUIRY CATEGORY</label>
                    <select
                      id="inquiryCategory"
                    ...
                    >
                      ...
                      <option value="Security">Security, Compliance & SLAs</option>
                    </select>
                  </div>
