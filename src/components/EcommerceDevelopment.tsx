...
const ECOMMERCE_SOLUTIONS = [
  {
    ...
    tools: ['Next.js', 'Storefront API', 'GraphQL', 'Hostinger CDN', 'Tailwind CSS']
  },
  {
...
const ECOMMERCE_FAQS = [
  ...
  },
  {
    ...
    a: 'Our headless architecture relies on edge CDN deployment (Hostinger/Cloudflare) and decoupled APIs capable of processing tens of thousands of concurrent checkouts per minute without performance degradation.'
  }
];
