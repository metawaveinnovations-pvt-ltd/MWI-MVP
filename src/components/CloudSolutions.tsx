...
const CLOUD_SOLUTIONS_CARDS = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    desc: 'Hardened cloud security postures featuring zero-trust network access, centralized IAM policies, automated vulnerability scanning, and robust security architecture.',
    highlights: [
      ...
      'Automated security monitoring and compliance-ready logging'
    ],
...
const CLOUD_FAQS = [
  ...
  {
    q: 'How do you ensure cloud security and data protection?',
