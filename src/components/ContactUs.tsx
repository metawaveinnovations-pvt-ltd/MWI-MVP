...
export function ContactUs() {
  ...
  const offices = {
    london: {
      city: 'UK Client Advisory & Delivery',
      address: 'UK Remote Collaboration & Strategic Consulting',
      coords: 'United Kingdom',
      phone: '+44 20 7496 0192',
      email: 'london@metawaveinnovations.com',
      hours: '09:00 AM - 06:00 PM GMT'
    },
    dubai: {
      city: 'UAE & GCC Client Services',
      address: 'GCC Remote Collaboration & Solutions Staging',
      coords: 'United Arab Emirates',
      phone: '+971 4 362 0000',
      email: 'dubai@metawaveinnovations.com',
      hours: '09:00 AM - 06:00 PM GST'
    },
    ny: {
      city: 'US Strategy & Advisory',
      address: 'North America Remote Delivery & Architecture',
    ...
    islamabad: {
      city: 'Pakistan Engineering R&D Center',
      address: 'MetaWave Technology Center, Islamabad, Pakistan',
  ...
  const faqList: FaqItem[] = [
    ...
    },
    {
      ...
      a: 'Yes. MetaWave Innovations is registered in Pakistan under SECP (Companies Act 2017) and enforces strict security practices including GDPR alignment, advanced data controls, and enterprise-grade security standards.'
    },
    {
...
with check (true);`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      <label htmlFor="name" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                        FULL NAME *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-205 rounded-xl text-xs sm:text-sm text-slate-800 placeholder-slate-500 focus:outline-none focus:border-[#326E45] focus:ring-1 focus:ring-[#326E45] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                    </div>

                    <div className="space-y-1.5">
                      <label htmlFor="email" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                        CORPORATE EMAIL *
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      <label htmlFor="company" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                        ORGANISATION NAME
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1.5">
                      <label htmlFor="phone" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                        TELEPHONE NUMBER
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      <label htmlFor="serviceNeeded" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-205 rounded-xl text-xs sm:text-sm text-slate-800 focus:outline-none focus:border-[#326E45] focus:ring-1 focus:ring-[#326E45] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                    ...
                    <div className="space-y-1.5">
                      <label htmlFor="budgetRange" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                        BUDGET EXPECTATION
                      </label>
                      <select
                        name="budgetRange"
                        id="budgetRange"
                        aria-label="Budget Expectation"
                        disabled={isSubmitting}
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="projectDetails" className="block text-[9px] font-mono text-slate-600 uppercase tracking-widest font-black pl-0.5">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-205 rounded-xl text-xs sm:text-sm text-slate-800 placeholder-slate-500 focus:outline-none focus:border-[#326E45] focus:ring-1 focus:ring-[#326E45] resize-none disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                  </div>
            ...
            <div className="p-5 rounded-3xl border border-slate-200 bg-white text-left space-y-4 shadow-2xs">
              ...
              <div className="relative h-44 bg-slate-50 rounded-2xl border border-slate-205 overflow-hidden flex items-center justify-center">
                ...
                <button onClick={() => setActiveOffice('london')} className="absolute left-[45%] top-[24%] group cursor-pointer">
                  <span className="absolute inset-0 w-5 h-5 rounded-full bg-emerald-500/10 blur-xs -translate-x-1.5 -translate-y-1.5 animate-ping" />
                  <span className={`block w-2.5 h-2.5 rounded-full border border-white ${activeOffice === 'london' ? 'bg-[#326E45] scale-125 shadow-sm' : 'bg-slate-450'}`} />
                </button>
