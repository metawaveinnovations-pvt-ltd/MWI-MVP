...
const ERP_STACK_TABS = [
  ...
  },
  {
    ...
    items: [
      { name: 'AES-256 Encryption & MFA', spec: 'Field-level database encryption, SAML 2.0 / SSO, and mandatory MFA access', benchmark: 'Enterprise Security' },
...
const ERP_FAQS = [
  ...
  },
  {
    ...
    a: 'Yes. All ERP platforms engineered by MetaWave feature field-level AES-256 data encryption, role-based access control (RBAC), multi-factor authentication (MFA), SAML 2.0 / SSO integration, and detailed audit logs aligned with enterprise security and GDPR requirements.'
  },
  {
