...
export function Insights() {
  ...
  const articles: ArticlePost[] = [
    ...
    {
      id: 'a2',
      title: 'How Global Enterprises Are Accelerating Digital Transformation with Pakistan Engineering Teams',
      summary: 'A strategic blueprint evaluating how software engineering teams in Pakistan are helping international companies modernize legacy ERP and cloud solutions cost-efficiently.',
      category: 'UK Business Technology',
      content: 'The UK and global enterprise markets are facing unprecedented pressure to modernise legacy workflows, secure database assets, and implement predictive business telemetry systems. However, a local shortage of senior systems developers has driven consulting expenses to unsustainable levels.\n\nAs a solution, leading organisations are partnering with technology engineering teams in Pakistan. Operating as a seamless remote extension through a globally connected collaboration network, these teams facilitate continuous joint development. This global delivery model allows international firms to build highly customized ERP systems, CRM platforms, and e-learning hubs at fractional costs compared to traditional local agencies.\n\nCrucially, complete code sovereignty must remain protected. High-end partnerships require comprehensive IP assignment contracts, secure cloud configurations, and rigorous data protection routines complying fully with international privacy standards.',
      author: 'Muntaha Sheikh (CEO & CTO | System Developer)',
      date: '28 April 2026',
      readTime: '8 min read',
  ...
  return (
    <section id="insights" className="py-20 sm:py-28 bg-mwi-base border-b border-mwi-shade-10/40 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none -z-10 bg-gradient-to-b from-white via-slate-50/50 to-white" />
      <div className="absolute top-[20%] left-[-10%] w-[450px] h-[450px] rounded-full bg-[#326E45]/[0.02] blur-[110px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16 space-y-4">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full border border-slate-200 bg-white shadow-xs">
            <BookOpen size={12} className="text-[#326E45]" />
            <span className="text-[10px] font-mono font-bold tracking-widest text-[#326E45] uppercase">
              RESEARCH & ANALYTICS
            </span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-display font-extrabold tracking-tight text-slate-900 leading-tight">
        ...
        <div className="flex overflow-x-auto gap-2 pb-6 scrollbar-none justify-start sm:justify-center max-w-5xl mx-auto">
          {categories.map((cat) => (
            <button
              key={cat}
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all border cursor-pointer ${
                selectedCat === cat
                  ? 'bg-[#326E45] border-[#326E45] text-white shadow-xs'
          ...
          <AnimatePresence mode="popLayout">
            {filteredArticles.map((article, idx) => (
              <motion.article
                ...
                className="group bg-white rounded-3xl border border-slate-200/90 overflow-hidden flex flex-col justify-between hover:border-[#326E45]/40 hover:shadow-xl transition-all duration-300 relative text-left min-h-[390px] hover:-translate-y-1"
                id={`article-${article.id}`}
              >
                <div>
                  {/* Category Pill Tag */}
                  <div className="p-4 flex justify-between items-center bg-slate-50/80 border-b border-slate-100">
                    <span className="text-[9px] font-mono font-bold bg-[#326E45]/10 text-[#326E45] px-2.5 py-0.5 rounded-full uppercase leading-none border border-[#326E45]/15">
                      {article.category}
                    </span>
                  ...
                  <div className="p-6 space-y-3">
                    ...
                    <h3 className="text-base font-display font-bold text-slate-900 leading-snug group-hover:text-[#326E45] transition-colors">
                      {article.title}
                    </h3>
                    <p className="text-xs text-slate-600 leading-relaxed font-normal lines-clipped overflow-hidden h-14">
                      {article.summary}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 pt-0">
                  <button
                    ...
                    className="w-full py-2.5 bg-slate-900 hover:bg-[#326E45] text-white transition-all rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 cursor-pointer shadow-xs duration-200"
                  >
        ...
        {activeArticle && (
          <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto relative p-6 sm:p-8 flex flex-col gap-6 text-left"
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-[9px] font-mono font-bold bg-[#326E45]/10 text-[#326E45] px-2.5 py-1 rounded-full uppercase leading-none border border-[#326E45]/15">
                ...
                <div className="p-3.5 bg-slate-50 border border-slate-200/80 rounded-2xl flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-[#326E45]/10 flex items-center justify-center font-display font-black text-[13px] text-[#326E45] border border-[#326E45]/20">
                    M
                  </div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal whitespace-pre-line pt-2">
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-[#326E45] hover:bg-[#275736] flex items-center gap-2 cursor-pointer shadow-sm transition-all"
                >
