...
export function FeaturedProducts() {
  ...
  const productsList = [
    ...
    },
    {
      ...
      metricTitle: 'Security Index',
      metricVal: 'Enterprise Grade',
      bgColor: 'teal',
      features: [
      ...
      benefits: [
        'Comprehensive health data privacy and peace of mind',
          ...
          >
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-2xl border border-slate-200/90 bg-slate-50 shadow-inner p-4 overflow-hidden">
                ...
                {/* Visual Product Hero Header */}
                <div className="relative h-40 rounded-xl overflow-hidden border border-slate-200 mb-4 group shadow-xs">
                  <img
                  ...
                  <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between">
                    <div>
                      ...
                      <span className="text-sm font-display font-bold text-white">
                        {activeProductData.name} Enterprise Console
                      </span>
                    </div>
                    <span className="text-[9px] font-mono bg-white/20 backdrop-blur-xs text-white border border-white/20 px-2 py-0.5 rounded font-bold">
                      Live Interface
                    </span>
                  </div>
                </div>
