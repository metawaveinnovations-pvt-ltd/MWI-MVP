            ...
            {type === 'privacy' && (
              <>
                <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 text-xs text-emerald-400 font-mono">
                  EFFECTIVE DATE: JULY 22, 2026 | COMPLIANCE: GDPR, CCPA & DATA PRIVACY STANDARDS
                </div>
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800">
                    ...
                    <p className="text-xs text-slate-300">
                      Our Pakistan-based engineering team and global remote collaboration network allow us to onboard senior full-stack React, Node, and AI developers within 48 to 72 hours.
                    </p>
                  </div>
                  <div className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800">
