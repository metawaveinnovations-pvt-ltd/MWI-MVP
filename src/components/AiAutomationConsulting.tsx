...
const AI_CONSULTING_SOLUTIONS: ConsultingSolution[] = [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    desc: 'Ensure alignment with GDPR, EU AI Act, and enterprise security standards while protecting your corporate IP against prompt injection, model poisoning, and data leaks.',
    highlights: [
              ...
              {!isSubmitted ? (
                <form onSubmit={handleBookingSubmit} className="space-y-3.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      <label htmlFor="primaryFocusArea" className="text-[10px] font-bold text-slate-600 block mb-1">Primary Focus Area</label>
                      <select
                        id="primaryFocusArea"
                        aria-label="Primary Focus Area"
