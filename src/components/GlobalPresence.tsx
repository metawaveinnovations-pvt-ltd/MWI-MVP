...
import mwiGlobalSystems from '../assets/images/mwi_global_systems_1782517569461.jpg';
  ...
  const markets: Market[] = [
    {
      ...
      role: 'Client Consultation & Strategic Advisory',
      description: 'Globally connected remote network providing executive strategy, client relations, and digital transformation consulting for enterprise clients across London, Manchester, and the UK.',
      tag: 'UK REGION',
    ...
    },
    {
      ...
      role: 'Middle-East Strategic Delivery Network',
      description: 'Strategic digital delivery for automated CRM/ERP ecosystems, retail business growth systems, and smart automation servicing Dubai, Abu Dhabi, and the GCC region.',
      tag: 'UAE & GCC',
    ...
    },
    {
      ...
      role: 'North America Strategy & Engineering',
      description: 'Serving North American clients with high-end cloud migration blueprints, zero-trust security frameworks, and custom SaaS platform architecture.',
      tag: 'US REGION',
    ...
    {
      country: 'Pakistan',
      role: 'Core Engineering & Systems R&D Center',
      description: 'Pakistan-based software engineering team specializing in custom software development, artificial intelligence model training, automated QA, and high-performance engineering delivery.',
      tag: 'PAKISTAN R&D CENTER',
      coords: '33.6844° N, 73.0479° E',
      presenceType: 'Delivery'
    },
    {
      country: 'Saudi Arabia & EU Zone',
      role: 'Target Remote Collaboration Expansion',
      description: 'Advancing our regional collaboration capabilities to support government digitisation initiatives and enterprise technology modernisation across Riyadh and Berlin.',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-12 xl:col-span-6 space-y-6 text-left">
            ...
            <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-normal">
              Our global delivery model combines strategic client consultation with a Pakistan-based engineering team and a globally connected remote collaboration network. By using direct real-time communication bridges and agile code reviews, we ensure seamless execution and project transparency.
            </p>
              ...
              <div className="relative h-56 w-full rounded-2xl overflow-hidden flex items-center justify-center border border-slate-200 bg-slate-950">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.src = '/assets/images/mwi_global_systems_1782517569461.jpg';
                  }}
                />
                ...
                >
                  <span className="absolute inset-0 w-6 h-6 rounded-full bg-emerald-400/30 -translate-x-2 -translate-y-2 animate-ping" />
