...
const CONSULTING_SOLUTIONS = [
  ...
  },
  {
    ...
    title: 'Cybersecurity Risk & Security Governance',
    subtitle: 'ENTERPRISE-GRADE SECURITY',
    icon: ShieldCheck,
    desc: 'Prepare your platform for enterprise-grade security standards and data protection guidelines through gap analysis, zero-trust security policies, and vulnerability remediation.',
    highlights: [
      'Enterprise security gap analysis & policy drafting',
      'Penetration testing, OWASP Top 10 vulnerability remediation',
      'Hardware secret vault integration & data encryption enforcement',
      'Incident response playbooks & continuous automated monitoring'
    ],
...
const CONSULTING_STACK_TABS = [
  ...
  },
  {
    ...
    items: [
      { name: 'Enterprise Security Frameworks', spec: 'End-to-end security control implementation & auditor readiness', benchmark: 'Production-Ready' },
    ...
    <div className="min-h-screen bg-mwi-base text-slate-800 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
          ...
          >
            Empower your organization with fractional CTO leadership, architectural audits, cloud FinOps cost optimization, enterprise security readiness, and M&A technical due diligence.
          </motion.p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-16">
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-4 flex items-center gap-3 shadow-xs">
            ...
            <div>
              <div className="text-slate-900 font-bold text-xs sm:text-sm">Enterprise Security</div>
