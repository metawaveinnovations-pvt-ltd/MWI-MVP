...
const JOBS: JobOpening[] = [
  {
    ...
    responsibilities: [
      'Design high-availability, sub-50ms multi-region cloud backend architectures with enterprise-grade security standards',
  ...
  },
  {
    ...
    experience: '5+ Years',
    skills: ['Enterprise Security', 'Data Protection & GDPR', 'HashiCorp Vault', 'Penetration Testing', 'SIEM'],
    responsibilities: [
      'Direct continuous automated security audits, vulnerability management, and enterprise-grade security architecture',
    ...
    requirements: [
      ...
      'Experience guiding enterprise B2B SaaS organizations through external security audits and rigorous data protection reviews'
    ]
  },
  {
    id: 'j5',
