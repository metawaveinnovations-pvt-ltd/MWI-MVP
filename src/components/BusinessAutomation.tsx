...
const AUTOMATION_SOLUTIONS = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Automated PII masking & redaction for data privacy compliance'
    ],
...
const AUTOMATION_STACK_TABS = [
  {
    ...
    items: [
      { name: 'UiPath & Power Automate', spec: 'Enterprise unattended bot orchestration with advanced security controls', benchmark: 'Zero-Error Bot' },
...
const AUTOMATION_FAQS = [
  ...
  },
  {
    ...
    a: 'Absolutely. We enforce zero-trust security practices: end-to-end TLS encryption, self-hosted n8n/Camunda instances inside your private cloud VPC, ephemeral processing without data persistence, and strict data privacy standards.'
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-16">
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-4 flex items-center gap-3 shadow-xs">
            ...
            <div>
              <div className="text-slate-900 font-bold text-xs sm:text-sm">Security-First Architecture</div>
