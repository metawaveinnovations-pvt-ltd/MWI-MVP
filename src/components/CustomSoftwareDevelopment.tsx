...
const SOFTWARE_STACK_TABS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Enterprise-Grade Security', spec: 'Strict encryption at rest (AES-256) and in transit (TLS 1.3)', benchmark: 'Audited Architecture' },
...
export function CustomSoftwareDevelopment({ onNavigate, isStandalonePage = false }: CustomSoftwareDevelopmentProps) {
  ...
  const calculatedEstimate = useMemo(() => {
    ...
    if (scaleGrade === 'global') {
      ...
      deliverables = 'Multi-Region Active-Active Cloud Architecture + Hardened Security Vault';
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-16">
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-4 flex items-center gap-3 shadow-xs">
            ...
            <div>
              <div className="text-slate-900 font-bold text-xs sm:text-sm">Secure Software Solutions</div>
