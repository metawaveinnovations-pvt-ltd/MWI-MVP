    ...
    <section id="trustees" className="py-10 bg-[#FAFBFD] border-y border-slate-200/50 overflow-hidden relative z-20">
      <div className="max-w-7xl mx-auto px-6 mb-6 text-center">
        <span className="text-xs font-semibold tracking-[0.25em] uppercase bg-gradient-to-r from-[#326E45] via-[#245032] to-slate-800 bg-clip-text text-transparent select-none drop-shadow-xs">
          VETTED GLOBAL ENTERPRISE STACK & SECURE CLOUD PARTNERS
        </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-2xl border border-slate-200/50 p-4.5 shadow-xs flex flex-col md:flex-row md:items-center gap-4 relative overflow-hidden">
          ...
          <div className="relative flex overflow-hidden w-full select-none rounded-xl py-1 group/marquee">
            {/* Subtle inner fade overlays */}
            <div className="absolute top-0 bottom-0 left-0 w-20 sm:w-28 bg-gradient-to-r from-white via-white/60 to-transparent z-20 pointer-events-none" />
            <div className="absolute top-0 bottom-0 right-0 w-20 sm:w-28 bg-gradient-to-l from-white via-white/60 to-transparent z-20 pointer-events-none" />

            {/* Marquee Track 1 */}
            <div className="flex shrink-0 items-center gap-11 pr-11 min-w-max animate-[marquee_45s_linear_infinite] group-hover/marquee:[animation-play-state:paused] will-change-transform">
            ...
            <div className="flex shrink-0 items-center gap-11 pr-11 min-w-max animate-[marquee_45s_linear_infinite] group-hover/marquee:[animation-play-state:paused] will-change-transform" aria-hidden="true">
              {marqueeList.map((category, idx) => (
