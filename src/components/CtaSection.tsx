...
import enterpriseDashboardMockup from '../assets/images/enterprise_dashboard_mockup_1782045880160.jpg';
...
export function CtaSection({ onCtaclick }: CtaSectionProps) {
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-white border-b border-slate-200/50 relative overflow-hidden">
              ...
              <div className="relative rounded-2xl overflow-hidden bg-slate-950 aspect-[16/10]">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.src = '/assets/images/enterprise_dashboard_mockup_1782045880160.jpg';
                  }}
                />
              </div>
