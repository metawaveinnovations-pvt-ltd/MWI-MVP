...
const FULLSTACK_SOLUTIONS = [
  {
    ...
    tech: ['Next.js 15', 'React 19', 'TypeScript', 'Tailwind CSS', 'Hostinger / Cloud Run']
  },
  {
    id: 'serverless-apis',
...
const FULLSTACK_STACK_TABS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Hostinger / Cloud CDN', spec: 'Global edge network hosting with instant CDN caching', benchmark: '< 50ms Edge TTFB' },
...
export function FullStackDevelopment({ onNavigate, isStandalonePage = false }: FullStackDevelopmentProps) {
  ...
  const [deploymentTarget, setDeploymentTarget] = useState<'cloud_run' | 'hostinger' | 'aws'>('cloud_run');
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      { id: 'hostinger', label: 'Hostinger Edge Network' },
