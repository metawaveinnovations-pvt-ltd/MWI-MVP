              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto items-stretch sm:items-center">
                ...
                <div className="relative flex-1 sm:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2 bg-slate-50 hover:bg-slate-100/60 border border-slate-200 text-xs font-semibold rounded-xl text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#326E45]/20 focus:border-[#326E45] transition-all"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="pl-8 pr-8 py-2 bg-slate-50 hover:bg-slate-100/60 border border-slate-200 text-xs font-bold rounded-xl text-slate-800 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#326E45]/20 focus:border-[#326E45] transition-all appearance-none"
                  >
                      ...
                      <div className="rounded-xl overflow-hidden aspect-[16/10] relative mb-4 shadow-2xs">
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            e.currentTarget.src = 'https://images.unsplash.com/photo-1551434678-e076c223a692?q=80&w=800&auto=format&fit=crop';
                          }}
                        />
                        ...
                        <form onSubmit={handleCheckoutSubmit} className="space-y-4">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="relative">
                              ...
                              <select
                                id="deploymentRegion"
                                aria-label="Target Deployment Region"
