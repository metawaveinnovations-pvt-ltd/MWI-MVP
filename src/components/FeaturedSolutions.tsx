...
export function FeaturedSolutions({ onCtaclick }: FeaturedSolutionsProps) {
  ...
  const businessSolutions = [
    ...
    },
    {
      ...
      features: ['Rigorous health data encryption layers', 'Custom FHIR-standard medical record synchronization', 'Secure electronic patient clinical dashboards'],
      color: 'from-emerald-500 to-teal-500',
