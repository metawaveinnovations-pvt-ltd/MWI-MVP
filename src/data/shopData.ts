...
export const shopProducts: ShopProduct[] = [
  {
    ...
    reviewsCount: 142,
    icon: Users,
    featuredImg: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=800&auto=format&fit=crop',
    badge: 'POPULAR',
    features: [
    ...
    techSpecs: {
      ...
      compliance: 'GDPR Coherent, Enterprise Security Standards',
  ...
  },
  {
    ...
    reviewsCount: 64,
    icon: UserCheck,
    featuredImg: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop',
    features: [
    ...
    techSpecs: {
      ...
      deployment: 'Hostinger / AWS ECS',
      compliance: 'Encrypted and data privacy aligned data streams',
  ...
  },
  {
    ...
    techSpecs: {
      ...
      deployment: 'Hostinger / Cloud Run / VPS',
  ...
  },
  {
    ...
    reviewsCount: 78,
    icon: Cpu,
    featuredImg: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop',
    badge: 'AI DRIVEN',
    features: [
    ...
    techSpecs: {
      ...
      compliance: 'Encrypted Data Transit Controls',
